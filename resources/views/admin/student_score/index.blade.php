        ...
        <div class="col-12">
            <div class="card box-shadow-0 border-info">
                ...
                <div class="card-content collpase show">
                    ...
                    <a href="/student_score/upload" class="btn btn-social btn-min-width mr-1 mb-1 btn-secondary pull-right" class="float-sm-left">
                        <span class="fa fa-plus"></span> Upload Siswa &nbsp; </a>

                        <a href="/student_score/upload" class="btn btn-social btn-min-width mr-1 mb-1 btn-primary pull-right" class="float-sm-left">
                        <span class="fa fa-plus"></span> Tambah Mapel &nbsp; </a>
