...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::prefix('/student_score')->group(function () {
        Route::get('/', [StudentScoreController::class, 'index']);
        Route::get('/upload', [StudentScoreController::class, 'upload']);
        Route::post('/', [StudentScoreController::class, 'store']);
        Route::post('/import_excel', [StudentScoreController::class, 'import_excel']);
        Route::get('/edit/{id}', [StudentScoreController::class, 'edit']);
        Route::get('/detail/{id}', [StudentScoreController::class, 'detail']);
        Route::patch('/{id}', [StudentScoreController::class, 'update']);
        Route::delete('/{id}', [StudentScoreController::class, 'destroy']);
    });
